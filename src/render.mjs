 ...
 */
export function buildFiles(rows, meta) {
...
export function renderWiki(meta) {
  if (!meta.deepwiki) return null
  const out = meta.out ?? 'docs'
  const lines = [
    HEADER.replace('DO NOT EDIT BY HAND. Regenerate with `cartograph`.', 'AI-GENERATED via DeepWiki — non-authoritative, regenerated with `cartograph --deepwiki`.'),
    '',
